					    	...
					    	@if(count($location_detail) > 0)
				    			@foreach($location_detail as $detail)
							    	<tr>
							        	...
							        	<td style="text-align: center;"><a href="{{ url('location/edit/'.$detail->id) }}"><i style="color: #69aa46!important;" class="icon-pencil mr-3 icon-1x"></i></a><a href="{{  }} "><i style="color: red;" class="icon-bin mr-3 icon-1x"></i></a></td>
						      		</tr>
				      			@endforeach
				    		@endif
					    </tbody>
