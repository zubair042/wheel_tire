				...
				<table class="table" id="main-datatable-users">
				    ...
				    <tbody>
				    	@if(count($account_detail) > 0)
				        	...
				        	<td style="text-align: center;"><a href="{{url('account/edit/'.$detail->id) }}"><i style="color: #69aa46!important;" class="icon-pencil mr-3 icon-1x"></i></a><a href="{{ action('') }} "><i style="color: red;" class="icon-bin mr-3 icon-1x"></i></a></td>
			      		</tr>	
				    		@endforeach
				    	@endif
