								...
								<div class="col-md-6 offset-md-3" style="background-color: #fafafa;">
									...
									<li class="media">
										...
										<div class="media-body" style="text-align: center;">
										 	<img src="{{asset('')}}assets/images/placeholders/fr1.png" width="80%" height="100%" alt="">
										</div>
									...
									<li class="media">
										...
										<div class="media-body" style="text-align: center;">
										 	<img src="{{asset('')}}assets/images/placeholders/fr.png" class="" width="100%" height="100%" alt="">
										</div>
